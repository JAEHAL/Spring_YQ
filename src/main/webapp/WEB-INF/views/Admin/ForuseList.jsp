...
<title>학생 사용 내역 관리</title>
</head>
<body>
<center>
	<form method="post" action="F_ID_Search">
...
<tr height=50>
<td width=100>${f_list.stu_id}</td>
<td width=100>${f_list.date}</td>
<td width=100>${f_list.chain}</td>
<td width=100>${f_list.mn_name}</td>
<td width=100>${f_list.mn_price}</td>
</tr>
</c:forEach>
</table>
</body>
