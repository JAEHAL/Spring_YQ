...
<title>학생 사용 내역 페이지</title>
</head>
<body>
<form method="post" action="back_main">
<input type="submit" value="뒤로"></form>
<br/>
<form action="OneWeek_foruse.do" method="post">
<input type="submit" value="1주일"></form>
<form action="OneMonth_foruse.do" method="post">
<input type="submit" value="1개월"></form>
<form action="ThreeMonth_foruse.do" method="post">
